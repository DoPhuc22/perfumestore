...
Route::middleware(CheckLoginCustomer::class)->group(function () {
    ...
    Route::get('/orders_history', [CustomerController::class, 'showOrdersHistory'])->name('orderHistory');
...
Route::prefix('admin/order')->group(function(){
    ...
    Route::get('/detail/{order}', [OrderController::class, 'showDetail'])->name('order.detail');
    Route::put('/detail/{order}', [OrderController::class, 'updateStatusOrder'])->name('order.status');
    //Route hiển thị form sửa
    Route::get('/{order}/order',[\App\Http\Controllers\OrderController::class, 'edit'])->name('order.edit');
    //Route update dữ liệu trên db
