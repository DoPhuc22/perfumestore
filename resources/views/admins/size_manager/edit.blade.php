...
<div id="content" class="">
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div class="justify-content-center mt-5" style="width: 520px">
            <h4 class="fs-1 text-white text-center">Edit Size #{{$size->id}}</h4>
            <form method="post" action="{{ route('size.update', $size) }}" enctype="multipart/form-data">
